...
/**
 * Create stop word map for quick search of word key.
 */
public class StopWordMap {
	private Map<String, Integer> stopWordMap;

	public StopWordMap() {
		String[] stopWord = new String[] { "a", "about", "above", "according", "across", "after", "afterwards",
				"afterwards", "again", "against", "albeit", "all", "almost", "alone", "along", "already", "also",
				...
				"beside", "besides", "between", "beyond", "both", "but", "by", "can", "cannot", "canst", "certain",
				"cf", "choose", "contrariwise", "cos", "could", "cu", "day", "do", "does", "doesn't", "doing", "dost",
				...
				"excepted", "excepting", "exception", "exclude", "excluding", "exclusive", "far", "farther", "farthest",
				"few", "ff", "first", "for", "formerly", "forth", "forward", "from", "front", "further", "furthermore",
				...
				"said", "sake", "same", "sang", "save", "saw", "see", "seeing", "seem", "seemed", "seeming", "seen",
				"seldom", "selves", "sent", "several", "shalt", "she", "should", "shown", "sideways", "since", "slept",
				"slew", "slung", "slunk", "smote", "so", "some", "somebody", "somehow", "someone", "something",
		...
		this.stopWordMap = createStopWordMap(stopWord);

	}

	public Map<String, Integer> getStopWordMap() {
		return this.stopWordMap;
	}

	private Map<String, Integer> createStopWordMap(String[] stopWordList) {
		Map<String, Integer> stopWordMap = new HashMap<>();
